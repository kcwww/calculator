...
def calculator(request):    
    ...
    if(free < gradu.free):
        flag = 1
        messages.error(request,"자유 선택 학점이 부족합니다.")

    if(error_sum > 10):
        messages.debug(request,"자유선택으로 인정되는 초과교양 학점은 10학점까지 인정됩니다. 초과 학점은 제외되었습니다.")
    ...
    if(flag):
        messages.error(request,"졸업이 불가능 합니다. 학점이 부족합니다.")
    else:
